...
ifeq ($(USE_LIBION),)
    $(info OpenCL SDK: Determining automatically whether to use libion or kernel uapi)
...
ifeq ($(USE_LIBION), true)
    ...
    OPENCL_SDK_SHARED_LIBS := libion libOpenCL_system
    ...
    OPENCL_SDK_SHARED_LIBS := libOpenCL_system
